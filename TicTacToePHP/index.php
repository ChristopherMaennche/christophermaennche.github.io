                            ...
                            if((is_array($boxes))){
                                ...
                                foreach($boxes as $box){
                                    ...
                                    <div class="col-4 bg-warning">
                                        <div class="button<?php echo $icnt; ?> <?php echo $tempClass; ?> <?php echo $box; ?>" style="text-align: center; border: 1px Solid black;">
                                            <div class="card-body ttButton" id="<?php echo $icnt; ?>">
                                                <?php echo $box; ?>
                                            </div>
                                        </div>
                                    </div>
                ...
                <?php
                    if($box === ""){
                        if($openSpaces[] = $icnt){
                            ...
                            echo '<center><h3 class="SpaceFull">Please Select an Empty Space</h3></center>';
                        }
                    }
                ?>
                $('#box').val($(this).attr('id'));
